...
```
## The PGE format
For the PGE pipeline, each unique target/read 
...
print(pop_freq)
```
There are 32 (2^5) sequence outputs. For example, the first sequence is "01101" which refers to a SNP at PF3D7_0417200:59, PF3D7_0417200:108, and PF3D7_0810800:540.
