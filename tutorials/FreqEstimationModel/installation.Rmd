...
## Step 1/1: what to do
These instructions are taken from the github ReadMe, which contains useful information [Readme](https://github.com/aimeertaylor/FreqEstimationModel)
...
Note that with some versions of R, we might be unable to build the vignettes. Either update R or set that call to FALSE.
