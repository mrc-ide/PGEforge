...
- A fully reproducible and worked-through tutorial showing example usage of the tool and its functionalities. This often uses the [canonical simulated or empirical datasets](website_docs/data_description.qmd) as input data
...
If you are interested in contributing, there are [templates available](https://mrc-ide.github.io/PGEforge/tutorials/Template/Template_background.html) and [instructions](website_docs/how_to_contribute.qmd) on how to get started. 